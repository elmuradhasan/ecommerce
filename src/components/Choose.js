        ...
        <div className='sub_div_choose full_w floating'>
          ...
          <div className='sub_item_main_div floating full_w flex'>
            <div className='choose_item_div first'>
              <b  className='flex'><i className="fa-solid fa-file"></i></b>
            ...
            <div className='choose_item_div'>
              <b  className='flex'><i className="fa-solid fa-comments"></i></b>
              <h3>Live Support</h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lobor ornare in mattis.</p>
            </div>
            <div className='choose_item_div'>
              <b  className='flex'><i className="fa-solid fa-layer-group"></i></b>
              <h3>Free Resource</h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lobor ornare in mattis.</p>
            </div>
            <div className='choose_item_div'>
             <b className='flex'><i className="fa-solid fa-recycle"></i></b>
